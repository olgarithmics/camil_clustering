...
#SBATCH --output=/home/ofourkioti/Projects/camil_clustering/results/cam17_max_pooling.txt
...
for i in {0..3};
do
python run.py  --experiment_name cam17_max_pooling   --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/cam-17/feats/h5_files/ --label_file label_files/camelyon_17.csv --csv_file camelyon_17_splits/splits_${i}.csv   --k_sample 8 --single_branch;
done
