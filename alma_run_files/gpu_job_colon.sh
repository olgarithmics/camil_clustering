...
for i in {0..4};
do python run.py --experiment_name colon_mb --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/colon_feats/h5_files/ --label_file label_files/colon_data.csv --csv_file colon_csv_splits/splits_${i}.csv  --epoch 1 --topk 5 --subtyping;
done