...
python run.py  --experiment_name lipo --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/SAR/feats/h5_files --label_file label_files/multi_lipo.csv --csv_file lipo_splits  --epoch 100 --save_dir SAR_Saved_model
