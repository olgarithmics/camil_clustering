...
#SBATCH --output=/home/ofourkioti/Projects/camil_clustering/results/tcga_camil_mb.txt
...
for i in {0..3};
do
python run.py  --experiment_name tcga_camil_mb --k 8 --feature_path /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/tcga_lung/feats/h5_files/ --label_file label_files/tcga_data.csv --csv_file tcga_lung_files/splits_${i}.csv  --k_sample 8 --subtyping;
done
